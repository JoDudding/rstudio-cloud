...
The folder we are in is
`r here::here()`

Here's the web copy of the hex.

```{r myhex, echo = FALSE, out.width = '25%'}
knitr::include_graphics("https://github.com/jodudding.png") # update USERNAME here
```

And here's the local copy.

<!-- 

This works too

![local hex](img/jo_hex.png)

-->

```{r myhexlocal, echo = FALSE, out.width = '25%'}
knitr::include_graphics(here::here('img', 'jo_hex.png'))
```
